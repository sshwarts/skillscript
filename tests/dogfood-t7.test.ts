...
describe("T7 — distributed code surface", () => {
  ...
  it("7. narrow-core LOC ceiling holds (< 5700 / 20 files; v0.2.10 → 5100, v0.2.12 → 5200, v0.3.0 → 5400, v0.3.1 → 5500, v0.3.2 → 5650, v0.3.3 → 5700)", () => {
    ...
    expect(Number(locStr)).toBeLessThan(5700);
