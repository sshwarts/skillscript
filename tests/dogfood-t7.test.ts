...
describe("T7 — package.json polish", () => {
  it("1. version is 0.2.3 (T7 + v0.2.1 trigger fix + v0.2.2 parser fixes + v0.2.3 authoring MCP)", () => {
    expect(PACKAGE_JSON["version"]).toBe("0.2.3");
  });
...
describe("T7 — CLI --help surface", () => {
  ...
  it("11. version flag reports 0.2.3", () => {
    const out = execSync(`${CLI} --version`, { encoding: "utf8" });
    expect(out.trim()).toBe("0.2.3");
  });
});
