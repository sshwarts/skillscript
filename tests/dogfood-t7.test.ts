...
describe("T7 — package.json polish", () => {
  it("1. version is 0.18.1 (AgentConnector declarative-wiring symmetry: agent_connector slot in connectors.json substrate + BootstrapOpts.agentConnector)", () => {
    expect(PACKAGE_JSON["version"]).toBe("0.18.1");
  });
