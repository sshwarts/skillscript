...
describe("T7 — package.json polish", () => {
  it("1. version is 0.26.6 (error-handling topic CORRECTNESS fix — `(fallback:)` does NOT catch an execute_skill/json_parse throw; two-failure-shapes framing, else:/structural-guard prescribed, # OnError: flagged inert; gate-dogfooded; Perry c052581b)", () => {
    expect(PACKAGE_JSON["version"]).toBe("0.26.6");
  });
