...
describe("T7 — package.json polish", () => {
  it("1. version is 0.18.0 (dashboard composition contract expansion + SkillMeta surface completion: vars + returns now populated)", () => {
    expect(PACKAGE_JSON["version"]).toBe("0.18.0");
  });
