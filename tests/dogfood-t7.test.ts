...
describe("T7 — package.json polish", () => {
  it("1. version is 0.15.4 (Phase 3 warm-adopter update: idempotent skill-store demo + SQLite warning suppression at load-site)", () => {
    expect(PACKAGE_JSON["version"]).toBe("0.15.4");
  });
