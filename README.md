...
[![tests](https://img.shields.io/badge/tests-631%2F631-green)](#)
...
**v0.2.8** — pre-1.0, breaking changes expected. The language is stable enough to author production skills; the surrounding tooling (CLI, dashboard, MCP server contract) may evolve before v1.0.

Test coverage: 631/631 passing. Narrow-core LOC under the 5000/20-file ceiling per ERD.
